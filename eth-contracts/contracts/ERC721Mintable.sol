...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(isOwner(), "Caller must be the owner of the contract.");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        emit OwnershipTransferCompleted(currentOwner, newOwner);
    }
...
// ******************************************
// Reviewer Note: Removed tokenURI as mentioned here - https://knowledge.udacity.com/questions/673523
// ******************************************
...
contract CustomERC721Token is ERC721Metadata {
    ...
    constructor(string memory name, string memory symbol) 
        ERC721Metadata(name, symbol, _baseTokenCustomURI) 
        public
    {
    }
